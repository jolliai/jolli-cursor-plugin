...
Add `jolliai/jolli-cursor-plugin` as a marketplace in Cursor, then install **Jolli Memory**
...
2. Add `jolliai/jolli-cursor-plugin` again. It now appears as **Jolli Cursor**.
...
```bash
git clone https://github.com/jolliai/jolli-cursor-plugin.git
```
